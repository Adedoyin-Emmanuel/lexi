  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background to-muted/20 flex items-center justify-center relative overflow-hidden">
      ...
      <div className="w-full max-w-md mx-auto text-center space-y-6 md:space-y-8 relative z-10 px-2 md:px-0">
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            <h1 className="text-2xl md:text-3xl font-bold bg-gradient-to-r from-foreground to-foreground/70 bg-clip-text text-transparent">
              {isExistingUser
                ? "You've been onboarded, chief!"
                : "You're all set!"}
            </h1>
            <p className="text-muted-foreground text-base md:text-lg">
              {isExistingUser
                ? "Welcome back! Your profile is ready to go."
        ...
        <Link href="/dashboard">
          <Button className="w-full h-12 bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary/70 cursor-pointer">
            {isExistingUser ? "Take me to dashboard" : "Continue"}
